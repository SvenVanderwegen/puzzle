...
<template>
    ...
    <main class="mx-auto flex max-w-[420px] flex-col gap-7 px-4 pt-16 pb-16">
        ...
        <form class="flex flex-col gap-4" @submit.prevent="submit">
            ...
            <label class="flex flex-col gap-1.5">
                <span class="text-[11px] tracking-[.09em] text-ash-dim uppercase">Confirm password</span>
                <input
            ...
            <button type="submit" class="bf-btn bf-btn-primary mt-2" :disabled="form.processing">Register</button>
        </form>
