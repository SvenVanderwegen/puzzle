 ...
 * the tripwire tests; @types/node is not on the dependency allowlist). No
 * runtime code; nothing ships. Same pattern as packages/ui-web.
 */

/** Minimal node:fs surface used by the tripwire tests. */
