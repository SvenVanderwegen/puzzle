...
<template>
    ...
    <main class="mx-auto flex max-w-[420px] flex-col gap-8 px-4 pt-6 pb-16">
        ...
        <form class="flex flex-col gap-4" @submit.prevent="submitProfile">
            <h2 class="text-[11px] font-semibold tracking-[.18em] text-ash-dim uppercase">Profile</h2>

            <label class="flex flex-col gap-1.5">
                <span class="text-[11px] tracking-[.09em] text-ash-dim uppercase">Name</span>
                <input
                ...
                />
                <span v-if="profileForm.errors.name" class="text-xs text-danger">{{ profileForm.errors.name }}</span>
            </label>
            ...
            <label class="flex flex-col gap-1.5">
                ...
                <input
                    ...
                    class="rounded-[5px] border border-line bg-transparent px-3 py-2 text-sm text-paper outline-none focus-visible:border-ember"
                />
                <span v-if="profileForm.errors.email" class="text-xs text-danger">{{ profileForm.errors.email }}</span>
            </label>
        ...
        <form class="flex flex-col gap-4 border-t border-line pt-7" @submit.prevent="submitPassword">
            <h2 class="text-[11px] font-semibold tracking-[.18em] text-ash-dim uppercase">Change Password</h2>

            <label class="flex flex-col gap-1.5">
                <span class="text-[11px] tracking-[.09em] text-ash-dim uppercase">Current password</span>
                <input
                    ...
                    class="rounded-[5px] border border-line bg-transparent px-3 py-2 text-sm text-paper outline-none focus-visible:border-ember"
                />
                <span v-if="passwordForm.errors.current_password" class="text-xs text-danger">{{ passwordForm.errors.current_password }}</span>
            </label>

            <label class="flex flex-col gap-1.5">
                <span class="text-[11px] tracking-[.09em] text-ash-dim uppercase">New password</span>
                <input
                    ...
                    class="rounded-[5px] border border-line bg-transparent px-3 py-2 text-sm text-paper outline-none focus-visible:border-ember"
                />
                <span v-if="passwordForm.errors.password" class="text-xs text-danger">{{ passwordForm.errors.password }}</span>
            </label>

            <label class="flex flex-col gap-1.5">
                <span class="text-[11px] tracking-[.09em] text-ash-dim uppercase">Confirm new password</span>
                <input
